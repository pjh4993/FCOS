...
from fcos_core.modeling.rpn.fcos_count.fcos import build_fcos_count
from fcos_core.modeling.rpn.counter.counter import build_counter
...
def build_rpn(cfg, in_channels):
    ...
    if cfg.MODEL.COUNTER_ON:
        return build_counter(cfg, in_channels)
    if cfg.MODEL.FCOS_COUNT_ON:
        return build_fcos_count(cfg, in_channels)
